 ...
 */
@FunctionalInterface
public interface TypeAnnotationRandomizer<A extends Annotation> {
     ...
     *         implementation
     */
    public Object getRandomValueForTypeAnnotation(Object bean, String propertyName, A annotation);
}
